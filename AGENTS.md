...
## USER CONTEXT — ACTIVE SUBSCRIPTIONS

| Provider | Status | Notes |
|----------|--------|-------|
| OpenRouter | subscribed | Used for vision models (multimodal-looker: `openrouter/google/gemini-2.0-flash-001`) and budget fallbacks. **Not yet integrated into CLI installer fallback chains** — manual config required. |
| OpenCode Go | subscribed | $10/mo, `opencode-go/minimax-m2.7` for quick tasks. Supported in TUI installer (`--opencode-go`). |
