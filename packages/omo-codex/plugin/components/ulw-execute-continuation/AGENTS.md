...
- `src/index.ts`: library barrel (`readContinuationState`, `getPlanChecklist`, `runStopHook`, `ULW_EXECUTE_CONTINUATION_DIRECTIVE`, `PlanChecklist`, `ContinuationState`, hook IO types); `src/directive.ts` loads and fills the template.
