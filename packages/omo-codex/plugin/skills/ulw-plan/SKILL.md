...
- **Epistemic workflow.** Planning claims keep a lightweight claim-graph, observation-manifest, verification-economics, and cause-disappearance trail in the draft: expected truth, observed reality, diff, and independent observation basis.
