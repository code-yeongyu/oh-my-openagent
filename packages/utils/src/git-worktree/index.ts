...
export { collectWorktreeDirtyStatus } from "./collect-worktree-dirty-status"
export type { WorktreeDirtyLifecycle, WorktreeDirtyStatus } from "./collect-worktree-dirty-status"
