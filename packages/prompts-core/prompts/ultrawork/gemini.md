...
**FIRST SIZE THE SCOPE** — count distinct surfaces, files, and steps — then decide. **YOU MUST ALWAYS INVOKE CALLABLE PLANNING DELEGATION FOR ANY NON-TRIVIAL TASK.**
...
3. GATHER -> CALLABLE PLANNING DELEGATION
