...
| 5+ dependent steps or unclear sequencing | Use callable planning delegation before implementation. |
...
| Callable planner | Large dependent work | Ordered waves and verification plan |
