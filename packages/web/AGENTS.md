...
├── scripts/prepare-build.mjs    # prepares build inputs and generated docs content
├── next.config.ts
├── open-next.config.ts
...
- Generated surfaces include `lib/docs-content.generated.ts` and `lib/og/fonts.ts`; update their source scripts or source docs, then regenerate rather than editing output.
...
- Docs content under `lib/docs-content.generated.ts` is generated by `scripts/generate-docs-content.mjs` (DO NOT EDIT marker) — edit the source docs, not the generated output. `lib/og/fonts.ts` is likewise generated by `scripts/generate-og-fonts.mjs`.
...
- Docs layout must preserve `min-w-0` and overflow handling: `components/docs/docs-shell.tsx` owns the desktop content scroll region, and the E2E suite asserts no horizontal overflow at 375px.
