...
export function createUlwLoopComponent(options: UlwLoopComponentOptions = {}): OmoOmpComponent {
  return {
    name: "ulw-loop",
...
function deliverContinuation(pi: OmpExtensionAPI, ctx: ComponentContext): void {
