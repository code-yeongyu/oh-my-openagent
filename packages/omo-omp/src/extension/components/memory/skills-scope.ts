 ...
 * handler is registered through OmpExtensionAPI.on, which is payload-agnostic.
 */
...
export function registerMemorySkillsScope(pi: OmpExtensionAPI, options: MemorySkillsScopeOptions): void {
