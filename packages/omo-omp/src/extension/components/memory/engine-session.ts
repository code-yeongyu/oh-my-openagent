...
// Shared engine-prep for the two memory tool surfaces (direct harness ToolDefinitions and the
// standalone MCP server). Pure memory-core + fs so the MCP bundle can inline it without the
// harness runtime.
