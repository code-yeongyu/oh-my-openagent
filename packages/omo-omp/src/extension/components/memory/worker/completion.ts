...
import type { OmoEntryRenderer } from "../../../types"
...
export interface ReflectionCompletionApi {
  ...
  registerEntryRenderer(customType: string, renderer: OmoEntryRenderer<ReflectionCompletionRecord>): void
}
...
export const renderReflectionCompletionEntry: OmoEntryRenderer<ReflectionCompletionRecord> = (entry) => {
