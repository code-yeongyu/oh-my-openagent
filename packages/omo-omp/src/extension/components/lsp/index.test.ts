...
describe("omo-omp lsp component", () => {
  it("#given the legacy LSP descriptors #when the daemon-backed component registers #then all non-executor descriptor fields are preserved", () => {
    // given / when
