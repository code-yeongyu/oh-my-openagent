import { reportToolHookStatus } from "../../tool-hook-status";
...
export function createLspComponent(options: LspComponentOptions = {}): OmoOmpComponent {
...
function registerLspFlags(pi: OmpExtensionAPI): void {
...
function registerLspTools(pi: OmpExtensionAPI): void {
	for (const tool of [
		lsp_diagnostics,
		lsp_goto_definition,
		lsp_find_references,
