...
describe("omo-omp lsp renderers", () => {
  it("#given registered LSP tools #when the host renders tool activity #then every tool exposes custom call and result renderers", () => {
    // given / when
