...
import type { OmpCommentCheckerBinaryResolverOptions } from "./types"
import { isCommentCheckerPackage } from "./utils"

export function resolveOmpCommentCheckerBinary(options: OmpCommentCheckerBinaryResolverOptions = {}): string | null {
