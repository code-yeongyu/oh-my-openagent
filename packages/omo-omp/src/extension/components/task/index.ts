...
import { createLeadPollerLifecycle, type LeadPollerLifecycle } from "../team/lead-poller-lifecycle"
import { TEAM_MEMBER_LIVENESS_MESSAGE_TYPE } from "../team/member-liveness"
...
import { createTeamMailboxReconciler, createTeamService } from "../team/team-service"
...
export function createTaskComponent(options: TaskComponentOptions = {}): OmoOmpComponent {
...
function registerRemovedTeamWaitHint(pi: OmpExtensionAPI): void {
...
function registerTaskFlags(pi: OmpExtensionAPI): void {
...
function registerTeamTools(pi: OmpExtensionAPI, context: TeamToolContext): void {
