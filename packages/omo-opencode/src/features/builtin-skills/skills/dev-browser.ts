...
export const devBrowserSkill: BuiltinSkill = {
  name: "dev-browser",
  description: "Browser automation with persistent page state — navigation, form filling, screenshots, data extraction, testing, and browser workflow automation. Trigger phrases include: 'go to [url]', 'click on', 'fill out the form', 'take a screenshot', 'scrape', 'automate', 'test the website', 'log into', or any browser interaction request.",
