...
export const agentBrowserSkill: BuiltinSkill = {
  name: "agent-browser",
  description: "Browser automation via agent-browser CLI — verification, browsing, information gathering, web scraping, testing, screenshots, and all browser interactions.",
