...
| **Hephaestus** | gpt-5.6-sol high (`reasoningEffort: medium`) | (model default) | primary | gpt-5.5 medium (`requiresProvider`: openai \| github-copilot \| opencode \| vercel) | Autonomous deep worker |
