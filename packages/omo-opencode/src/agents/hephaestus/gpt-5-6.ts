...
- Prefer \`run_in_background=true\` when the delegated unit is independent and you can continue non-overlapping work; use \`run_in_background=false\` when your next action depends on its result. Background delegation is not limited to exploration. Give concurrent executors disjoint file ownership.
