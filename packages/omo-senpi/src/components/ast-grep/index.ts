...
// Lets an Electron host binary (process.execPath) execute the staged script
// without launching a transient desktop app instance; inert for node and bun.
  ...
  return {
    ...
    register(pi: SenpiExtensionAPI, ctx: ComponentContext): void {
      ...
      pi.registerMcpServer(AST_GREP_MCP_SERVER_NAME, {
        ...
        args: [entry, "mcp"],
        env: {
          [PROJECT_CWD_ENV]: env[PROJECT_CWD_ENV] ?? resolveCwd(),
          [BUN_BE_BUN_ENV]: "1",
