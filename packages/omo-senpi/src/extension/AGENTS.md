...
| `component-list.ts` | `createOmoSenpiComponents(taskComponent)`: the 19-component registration array; the task component is injected by the entry file. Order is load-bearing (documented in `../../AGENTS.md`). |
