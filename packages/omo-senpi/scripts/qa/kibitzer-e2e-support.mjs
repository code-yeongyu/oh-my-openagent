#!/usr/bin/env bun
// Shared sandbox / RPC / mock-router harness for kibitzer live drivers.
...
export async function seedMemoryRepo(options, sandbox, env, router) {
  ...
  router.setParentSteps([
    { type: "tool_call", name: "memory", arguments: { command: "create", file_path: SEED_PATH, description: SEED_DESCRIPTION, file_text: SEED_BODY, reason: "seed the recall corpus for the kibitzer gate proof" } },
