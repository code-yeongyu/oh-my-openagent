...
`,tools:[{pattern:"read",allow:!0},{pattern:"find",allow:!0},{pattern:"grep",allow:!0},{pattern:"ls",allow:!0},{pattern:"bash",allow:!0},{pattern:"lsp_diagnostics",allow:!0},{pattern:"lsp_goto_definition",allow:!0},{pattern:"lsp_find_references",allow:!0},{pattern:"lsp_symbols",allow:!0}]};var V={name:"momus",description:"Expert reviewer for evaluating work plans against rigorous clarity, verifiability, and completeness standards.",mode:"subagent",executionMode:"in-process",prompt:`You are a **practical** work plan reviewer. Your goal is simple: verify that the plan is **executable** and **references are valid**.
...
`,tools:[{pattern:"read",allow:!0},{pattern:"find",allow:!0},{pattern:"grep",allow:!0},{pattern:"ls",allow:!0},{pattern:"bash",allow:!0},{pattern:"lsp_diagnostics",allow:!0},{pattern:"lsp_goto_definition",allow:!0},{pattern:"lsp_find_references",allow:!0},{pattern:"lsp_symbols",allow:!0}]};var d=[z,U,q,V],$=Object.fromEntries(d.map((e)=>[e.name,e])),f=new Set(d.map((e)=>e.name));var T=Object.freeze({type:"boolean"}),p=Object.freeze({type:"number"}),c=Object.freeze({type:"string"});function a(e){return Object.freeze({type:"string",values:Object.freeze(e)})}var L=Object.freeze({anthropic:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),"anthropic-api":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),deepseek:Object.freeze(["deepseek-v4-flash","deepseek-v4-pro"]),google:Object.freeze(["gemini-3.6-flash"]),"github-copilot":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","gpt-5.6-sol","gpt-5.6-terra"]),"kimi-for-coding":Object.freeze(["k3","kimi-for-coding-highspeed","kimi-k3"]),moonshotai:Object.freeze(["kimi-k3"]),openai:Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),opencode:Object.freeze(["claude-opus-5","claude-sonnet-5","gpt-5.6-sol","kimi-k3"]),"opencode-go":Object.freeze(["deepseek-v4-pro","kimi-k3","minimax-m2.7","minimax-m3"]),"quotio-openai":Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),vercel:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","deepseek-v4-flash","deepseek-v4-pro","gemini-3.6-flash","gpt-5.6-sol","gpt-5.6-terra","kimi-k3","minimax-m2.7","minimax-m3"]),xai:Object.freeze(["grok-4.20-0309-non-reasoning"])}),G=Object.freeze(Object.keys(L)),ze=Object.freeze([...f]),Ue=Object.freeze(g.map(({name:e})=>e)),qe=Object.freeze(["ast-grep","coding-agent-sessions","data-scientist","debugging","frontend","git-master","give-me-tips","hyperplan","init-deep","lsp-setup","onboarding","programming","refactor","remove-ai-slops","review-work","start-work","ultimate-browsing","ultrawork","ulw-loop","ulw-plan","ulw-research","visual-qa"]),Ve=Object.freeze({daily_active:Object.freeze({$session_id:c,day_utc:c,reason:a(["session_start"])}),session_started:Object.freeze({$session_id:c,$os:c,$os_version:c,arch:c,cpu_count:p,default_model:a([...new Set(Object.values(L).flat()),"custom"]),default_provider:a([...G,"custom"]),memory_bucket:a(["lt_8_gb","8_15_gb","16_31_gb","32_63_gb","64_plus_gb"]),model_count:p,provider_count:p,providers:c,reason:a(["startup","reload","new","resume","fork"])}),prompt_submitted:Object.freeze({$session_id:c,input_source:a(["interactive","rpc","extension"]),invocation_stage:a(["none","first_arm","remention","post_compact_rearm"]),is_effective_ultrawork_invocation:T,is_real_user_prompt:T,is_turn_start:T,keyword_any:T,keyword_occurrence_bucket:a(["1","2","3_5","6_plus"]),keyword_ultrawork_full:T,keyword_ulw_abbrev:T,keyword_variant:a(["none","ulw","ultrawork","both"]),prompt_length_bucket:a(["lt_100","100_500","500_2000","gte_2000"]),queue_mode:a(["immediate","follow_up","steer","other"]),real_prompt_ordinal_bucket:a(["1","2_3","4_10","11_25","26_plus"]),suppression_reason:a(["none","no_keyword","extension_source","embedded_directive","skill_expansion","skill_name_only"])}),turn_completed:Object.freeze({$session_id:c,cache_read_tokens:p,cache_write_tokens:p,cost_usd:p,input_tokens:p,model_id:a([...new Set(Object.values(L).flat()),"custom"]),output_tokens:p,provider:a([...G,"custom"]),reasoning_tokens:p,total_tokens:p,turn_index:p}),skill_loaded:Object.freeze({$session_id:c,skill_name:a(qe)}),delegation_started:Object.freeze({$session_id:c,background:T,batch_size_bucket:a(["1","2_4","5_plus"]),kind:a(["category","subagent"]),name:a([...Ue,...ze,"custom"])}),feature_used:Object.freeze({$session_id:c,feature:a(["goal_tool","team_create","memory_tool"])})}),Ki=Object.freeze(Object.fromEntries(Object.entries(Ve).map(([e,t])=>[e,Object.freeze(Object.keys(t))]))),Qi=$e();function Z(){return Xe(new URL("../skills/",import.meta.url))}function $e(){try{let e=JSON.parse(Oe(new URL("../../../package.json",import.meta.url),"utf8"));if(e!==null&&typeof e==="object"&&!Array.isArray(e)){let t=Reflect.get(e,"version");if(typeof t==="string")return t}}catch{return"0.0.0"}return"0.0.0"}import{existsSync as mt}from"node:fs";import{join as gt}from"node:path";var J=0.5,K=8,Q=500,W=3,R=30,x=0.15,C=0.25,D=90,j=7,A=86400000,k=new Set([".ts",".tsx",".js",".jsx",".py",".go",".rs",".java",".kt",".swift",".rb",".php",".c",".cpp",".cs",".scala",".lua",".ex",".exs",".zig",".dart"]),P=new Set(["node_modules",".git","dist","build","vendor",".next","__pycache__",".venv","target","coverage","third_party"]);import{existsSync as Ge,readdirSync as Ze,readFileSync as Je}from"node:fs";import{dirname as Ke,extname as Qe,join as h}from"node:path";function We(e,t){let n=t;for(;;){if(Ge(h(n,"AGENTS.md")))return!0;if(n===e)return!1;let r=Ke(n);if(r===n)return!1;n=r}}function je(e){let t=[];return ee(e,e,0,t),t}function B(e){let t=je(e);if(t.length===0)return null;let n=t.filter((i)=>i.covered).length,r=n/t.length;return{coverage:r,missingRatio:1-r,candidateDirs:t.length,coveredDirs:n}}function Y(e,t){if(e===null)return!1;return e>=J}function ee(e,t,n,r){if(n>W)return;let i;try{i=Ze(t,{withFileTypes:!0})}catch{return}if(n>=1){let o=i.filter((u)=>!u.isSymbolicLink()&&u.isFile()&&k.has(Qe(u.name))),s=o.reduce((u,m)=>u+Je(h(t,m.name),"utf8").split(`
`).length,0);if(o.length>=K||s>=Q)r.push({path:t,files:o.length,loc:s,covered:We(e,t)})}for(let o of i){if(o.isSymbolicLink()||!o.isDirectory())continue;if(P.has(o.name))continue;ee(e,h(t,o.name),n+1,r)}}import{execFileSync as Pe}from"node:child_process";import{readFileSync as Be,realpathSync as rs}from"node:fs";import{extname as Ye,join as et,resolve as is}from"node:path";var te=[":(exclude)AGENTS.md",":(exclude,glob)**/AGENTS.md",":(exclude).omo/init-deep.json"];function S(e,t){return Pe("git",[...t],{cwd:e,encoding:"utf8"})}function tt(e){let t=0;for(let n of e)if(n==="\x00")t+=1;return t}function ne(e){return S(e,["rev-parse","HEAD"]).trim()}function re(e,t){return Number(S(e,["rev-list","--count",`${t}..HEAD`]).trim())}function oe(e){return tt(S(e,["ls-files","-z"]))}function ie(e,t){return S(e,["diff","--name-only","-z","--find-renames",t,"HEAD","--",".",...te]).split("\x00").filter((r)=>r.length>0)}function se(e,t){let r=S(e,["diff","--numstat","-z","--find-renames",t,"HEAD","--",".",...te]).split("\x00"),i=0;for(let o=0;o<r.length;o+=1){let s=r[o];if(s.length===0)continue;let[u,m,y]=s.split("\t");if(y==="")o+=2;if(u==="-"||m==="-")continue;i+=Number(u)+Number(m)}return i}function ae(e){let t=S(e,["ls-files","-z"]).split("\x00").filter((r)=>r.length>0&&k.has(Ye(r))),n=0;for(let r of t){let i=Be(et(e,r),"utf8");for(let o of i)if(o===`
`)n+=1}return n}function ue(e,t){try{return S(e,["cat-file","-t",t]).trim()}catch{return null}}function le(e,t){if(ue(e,t.commitSha)!=="commit")return{kind:"stale",stale:!0};let n=re(e,t.commitSha),r=ie(e,t.commitSha).length,i=oe(e),o=se(e,t.commitSha),s=ae(e);return{kind:"valid",commitsSince:n,touchedFiles:r,trackedFiles:i,touchedRatio:r/Math.max(i,1),churnLoc:o,totalLoc:s,churnLocRatio:o/Math.max(s,1),daysSince:(Date.now()-t.timestamp)/A}}function v(e,t,n,r){if(t===n)return!1;if(Date.now()<r)return!1;if(e.kind==="stale")return!0;return e.commitsSince>=R&&e.touchedRatio>=x||e.churnLocRatio>=C||e.daysSince>=D}import{execFileSync as nt}from"node:child_process";import{createHash as rt,randomUUID as ot}from"node:crypto";import{existsSync as ce,mkdirSync as M,readFileSync as pe,realpathSync as it,renameSync as st,unlinkSync as at,writeFileSync as ut}from"node:fs";import{join as l,resolve as lt}from"node:path";var me="init-deep-advisor-declined-global",ge="init-deep-advisor-declined-projects",Te="init-deep-advisor-cooldowns",Se="init-deep-advisor-proposals",ct=l(".omo","init-deep.json");function de(e){let t=nt("git",["rev-parse","--git-common-dir"],{cwd:e,encoding:"utf8"}).trim();return rt("sha256").update(it(lt(e,t))).digest("hex")}function fe(e){M(e,{recursive:!0}),b(l(e,me),JSON.stringify({declinedAt:Date.now()}))}function Re(e){try{return ce(l(e,me))}catch{return!1}}function xe(e,t){let n=l(e,ge);M(n,{recursive:!0}),b(l(n,t),JSON.stringify({declinedAt:Date.now()}))}function Ce(e,t){try{return ce(l(e,ge,t))}catch{return!1}}function De(e,t,n){let r=l(e,Te);M(r,{recursive:!0}),b(l(r,t),JSON.stringify({until:n+j*A}))}function Ae(e,t){let n=Ee(l(e,Te,t));if(!E(n))return 0;let r=n.until;if(typeof r!=="number"||!Number.isFinite(r)||r<0)return 0;return r}function ke(e,t,n){let r=l(e,Se);M(r,{recursive:!0}),b(l(r,t),JSON.stringify({lastProposedHead:n,lastProposedAt:Date.now()}))}function Me(e,t){let n=Ee(l(e,Se,t));if(!E(n))return null;let r=n.lastProposedHead;return typeof r==="string"?r:null}function be(e){let t;try{t=pe(l(e,ct),"utf8")}catch(m){return pt(m)==="ENOENT"?{kind:"missing"}:{kind:"invalid"}}let n;try{n=JSON.parse(t)}catch{return{kind:"invalid"}}if(!E(n))return{kind:"invalid"};let{commitSha:r,fileCount:i,loc:o,timestamp:s,mode:u}=n;if(typeof r!=="string")return{kind:"invalid"};if(!I(i)||!I(o)||!I(s))return{kind:"invalid"};if(u!=="local"&&u!=="committed")return{kind:"invalid"};return{kind:"valid",snapshot:{commitSha:r,fileCount:i,loc:o,timestamp:s,mode:u}}}function b(e,t){let n=`${e}.${process.pid}.${ot()}.tmp`;try{ut(n,t,{mode:384}),st(n,e)}finally{try{at(n)}catch{}}}function Ee(e){try{return JSON.parse(pe(e,"utf8"))}catch{return}}function I(e){return typeof e==="number"&&Number.isFinite(e)&&e>=0}function pt(e){if(!E(e))return;let t=e.code;return typeof t==="string"?t:void 0}function E(e){return e!==null&&typeof e==="object"&&!Array.isArray(e)}function ye(e,t,n,r){let i=be(e);if(i.kind==="missing"){let s=B(e);if(!Y(s?.missingRatio??null,mt(gt(e,"AGENTS.md"))))return null;if(t===n||Date.now()<r)return null;return{trigger:"coverage-gap",coverage:{missingRatio:s.missingRatio,candidateDirs:s.candidateDirs,coveredDirs:s.coveredDirs}}}if(i.kind==="invalid")return Tt(t,n,r);let o=le(e,i.snapshot);if(!v(o,t,n,r))return null;if(o.kind==="stale")return{trigger:"snapshot-invalid",drift:{stale:!0}};return St(o)}function Tt(e,t,n){if(!v({kind:"stale",stale:!0},e,t,n))return null;return{trigger:"snapshot-invalid",drift:{stale:!0}}}function St(e){let t={commitsSince:e.commitsSince,touchedRatio:e.touchedRatio,churnLocRatio:e.churnLocRatio,daysSince:e.daysSince};if(e.commitsSince>=R&&e.touchedRatio>=x)return{trigger:"commit-and-touch",drift:t};if(e.churnLocRatio>=C)return{trigger:"loc-churn",drift:t};if(e.daysSince>=D)return{trigger:"snapshot-age",drift:t};throw Error("eligible drift has no trigger")}function Le(e,t,n){if(t.trigger==="coverage-gap")return{repo:e,trigger:t.trigger,coverage:t.coverage,drift:null,suggestedMode:n};if(t.trigger==="snapshot-invalid")return{repo:e,trigger:t.trigger,coverage:null,drift:t.drift,suggestedMode:n};return{repo:e,trigger:t.trigger,coverage:null,drift:t.drift,suggestedMode:n}}var ft=["Run now","Skip this time","Never in this project","Never anywhere"];async function Hs(e,t,n){let{root:r,stateDir:i}=n,o=de(r);if(Re(i))return;if(Ce(i,o))return;let s=Ae(i,o);if(Date.now()<s)return;let u=ne(r),m=ye(r,u,Me(i,o),s);if(m===null)return;ke(i,o,u),await new Promise((he)=>setTimeout(he,0));let y=await t.ui?.select("Init-deep",[...ft],{timeout:60000});Rt(y,e,i,o,r,m)}function Rt(e,t,n,r,i,o){if(e==="Run now"){let s=Z();t.sendMessage({customType:"omo-init-deep-advisor:run",content:`Read the init-deep skill at ${s}/init-deep/SKILL.md with the read tool and follow it.`,display:!1},{triggerTurn:!0,deliverAs:"followUp"}),t.appendEntry?.("omo-init-deep-advisor:proposed",Le(r,o,xt(i)));return}if(e==="Skip this time"||e===void 0){De(n,r,Date.now());return}if(e==="Never in this project"){xe(n,r);return}if(e==="Never anywhere")fe(n)}function xt(e){try{return dt("git",["ls-files","--error-unmatch","AGENTS.md"],{cwd:e,encoding:"utf8",stdio:["ignore","pipe","ignore"]}),"committed"}catch{return"local"}}export{Hs as runAdvisorAfterPreflight};
