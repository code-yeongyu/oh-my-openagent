...
- **explore** (`opencode/grok-code` 또는 `google/gemini-3-flash`): 빠른 코드베이스 탐색, 파일 패턴 매칭. Antigravity 인증이 설정된 경우 Gemini 3 Flash를 사용하고, 그렇지 않으면 Grok을 씁니다—무료이고, 극도로 빠르며, 파일 탐색 작업에 충분한 지능을 갖췄습니다. Claude Code 에서 영감을 받았습니다.
