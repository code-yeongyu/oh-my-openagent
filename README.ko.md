...
**Hephaestus** (`gpt-5.5`)는 당신의 자율 딥 워커입니다. 레시피가 아니라 목표를 주세요. 베이비시터 없이 알아서 코드베이스를 탐색하고, 패턴을 연구하며, 끝에서 끝까지 전부 해냅니다. _진정한 장인(The Legitimate Craftsman)._
...
>
> Opus에서 제일 잘 돌아가긴 하지만, Kimi K2.5 + GPT-5.5 조합만으로도 바닐라 Claude Code는 가볍게 바릅니다. 설정도 필요 없습니다.
