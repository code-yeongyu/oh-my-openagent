...
EVIDENCE="/tmp/pr6043-overlap-live-evidence"
ASSET_EVIDENCE="$ROOT/.omo/evidence/20260717-pr-6043-final-round13"
SOURCE_PATHS=(
  packages/omo-opencode/src/hooks/runtime-fallback/abort-wire-ordering.test.ts
  packages/omo-opencode/src/hooks/runtime-fallback/auto-retry-timeout.ts
  packages/omo-opencode/src/hooks/runtime-fallback/auto-retry-timeout-overlap.test.ts
  packages/omo-opencode/src/hooks/runtime-fallback/first-prompt-watchdog-fire.ts
  packages/omo-opencode/src/hooks/runtime-fallback/first-prompt-watchdog-ownership-races.test.ts
  packages/omo-opencode/src/hooks/runtime-fallback/first-prompt-watchdog-test-helpers.ts
  packages/omo-opencode/src/hooks/runtime-fallback/first-prompt-watchdog.ts
)
RUNTIME_SOURCE_PARENT="b1054147ea5e0d28b6e20bc4a36e4c1f53d7c0a0"
RUNTIME_SOURCE_HEAD="07075f4be9d87a9ab4213b127b23975de6709adb"
