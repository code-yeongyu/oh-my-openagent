...
- Runtime source parent: `c71b41c1574a191a51c7497da43c11d5d2aa9d0e`.
- Committed runtime source: `0dd0ab901c8ddc1a49155efddad7aea982c9a458`.
- Integrated base: `8af398565abfaece6d5fc3e6bc4ef0c7efa9bb7a`.
- Exact committed runtime diff SHA-256 used by live QA: `7a7c0e2dff2e09100c8fee327680218560fa9cee38a24b215efb7f95ffab0582`.
- The source diff is limited to seven runtime-fallback production/test files.
- The live harness requires a clean worktree, asserts the runtime source is an ancestor of its run head, and derives the diff from the two committed source identities above.
...
- OpenCode adapter typecheck, scoped Biome lint, forbidden-pattern audit, pure-LOC checks, and committed-diff integrity passed. `first-prompt-watchdog.ts` remains at 249 pure LOC.
