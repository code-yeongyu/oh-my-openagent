...
**Lower-risk overrides** (compatible behavior): Sisyphus Opus → Sonnet/Kimi K2.7/K2.6/K2.5/GLM 5.2/5.1/5; Prometheus Opus → GPT-5.5 (same prompt, different model); Atlas Kimi K2.6 → Sonnet/GPT-5.5 (auto-switch).
