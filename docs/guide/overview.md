...
Sisyphus works best on Claude Opus 4.7, Kimi K2.5, and GLM 5. GPT-5.5 now has a dedicated prompt path, but older GPT models are still a poor fit and should route to Hephaestus instead.
...
```jsonc
{
  ...
  "categories": {
    ...
    "deep": { "model": "openai/gpt-5.5", "variant": "high" },
