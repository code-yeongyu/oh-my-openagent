...
│                      PHASE 2A: 探索与研究                                    │
│  ┌─────────────────────────────────────────────────────────────────────┐    │
│  │ Sisyphus 并行调用 explore/librarian Subagents（后台）                │    │
│  │ ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐   │    │
...
│  │  │           ↓              │  │    │  ┌──────┐┌──────┐┌──────┐     │   │
│  │  │ ② Dispatch 执行者       │  │    │  │Wave 0││Wave 1││Wave 2│     │   │
│  │  │    按任务类型选择:       │  │    │  │      ││      ││      │     │   │
│  │  │    • 代码 → Junior       │  │    │  │Impl-1││Impl-3││Impl-5│     │   │
│  │  │      +tdd/debugging      │  │    │  │Impl-2││Impl-4││Impl-6│     │   │
│  │  │    • UI → Frontend       │  │    │  │(串行)││(串行)││(串行)│     │   │
│  │  │      +frontend-ui-ux     │  │    │  └──┬───┘└──┬───┘└──┬───┘     │   │
│  │  │      +playwright         │  │    │     │       │       │         │   │
│  │  │    • 文档 → Doc-Writer   │  │    │     └───────┴───────┘         │   │
│  │  │    • 咨询 → Oracle(只读) │  │    │             │                 │   │
│  │  │           ↓              │  │    │  4. 每 Wave 完成后:            │   │
│  │  │ ③ codex-mcp-collab      │  │    │     执行 codex-mcp-collab     │   │
│  │  │    检查点3: 变更审查     │  │    │     (检查点3: 变更审查)        │   │
│  │  │           ↓              │  │    │             │                 │   │
│  │  │ ④ 验证                  │  │    │  5. 验证                       │   │
