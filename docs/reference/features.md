...
| **review-work**        | "review work", "review my work", "QA my work"          | Post-implementation review orchestrator. Uses one comprehensive reviewer by default for goal compliance, QA evidence, code quality, relevant security concerns, and project context. Adds at most one specialist only for a stated concrete risk or unresolved question.                                                                          |
