...
| **Athena**            | `claude-opus-4-6`   | `claude-opus-4-6` → `kimi-k2.5` → `glm-4.7` → `gpt-5.4` → `gemini-3.1-pro`  |
| **Athena-Junior**     | `claude-opus-4-6`   | `claude-opus-4-6` → `kimi-k2.5` → `glm-4.7` → `gpt-5.4` → `gemini-3.1-pro`  |
