...
| **Athena**            | `claude-opus-4-6`   | `anthropic\|github-copilot\|opencode/claude-opus-4-6` → `opencode-go/kimi-k2.5` → `opencode-go/glm-4.7` → `openai\|github-copilot\|opencode/gpt-5.4` → `google\|github-copilot\|opencode/gemini-3.1-pro` |
| **Athena-Junior**     | `claude-opus-4-6`   | `anthropic\|github-copilot\|opencode/claude-opus-4-6` → `opencode-go/kimi-k2.5` → `opencode-go/glm-4.7` → `openai\|github-copilot\|opencode/gpt-5.4` → `google\|github-copilot\|opencode/gemini-3.1-pro` |
