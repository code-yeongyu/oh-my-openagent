...
| **librarian**         | `gemini-3-flash`    | `gemini-3-flash` → `minimax-m2.7-free` → `big-pickle`                        |
| **explore**           | `grok-code-fast-1`  | `grok-code-fast-1` → `minimax-m2.7-free` → `claude-haiku-4-5` → `gpt-5-nano` |
