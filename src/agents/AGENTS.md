...
| **Librarian** | gemini-3-flash | 0.1 | subagent | minimax-m2.7-free → big-pickle | External docs/code search |
| **Explore** | grok-code-fast-1 | 0.1 | subagent | minimax-m2.7-free → claude-haiku-4-5 → gpt-5-nano | Contextual grep |
