...
| **Athena** | claude-opus-4-6 max | 0.1 | primary | kimi-k2.5 → glm-4.7 → gpt-5.4 high → gemini-3.1-pro high | Interactive council orchestrator |
| **Athena-Junior** | claude-opus-4-6 max | 0.1 | subagent | kimi-k2.5 → glm-4.7 → gpt-5.4 high → gemini-3.1-pro high | Non-interactive council orchestrator |
