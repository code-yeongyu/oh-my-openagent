...
export const AGENT_MODEL_REQUIREMENTS: Record<string, ModelRequirement> = {
  sisyphus: {
    fallbackChain: [
      ...
      { providers: ["openai", "github-copilot"], model: "gpt-5.4", variant: "medium" },
  ...
  hephaestus: {
    fallbackChain: [
      {
        providers: ["openai", "github-copilot", "venice"],
        model: "gpt-5.4",
        variant: "medium",
      },
    ],
    requiresProvider: ["openai", "github-copilot", "venice"],
  },
  oracle: {
    fallbackChain: [
      {
  ...
  "multimodal-looker": {
    fallbackChain: [
      ...
      { providers: ["openai", "github-copilot"], model: "gpt-5-nano" },
    ],
  },
  prometheus: {
    fallbackChain: [
...
export const CATEGORY_MODEL_REQUIREMENTS: Record<string, ModelRequirement> = {
  ...
  artistry: {
    fallbackChain: [
      ...
      { providers: ["openai", "github-copilot"], model: "gpt-5.4" },
    ],
