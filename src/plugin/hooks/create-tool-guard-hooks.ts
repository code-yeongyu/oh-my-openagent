...
export type ToolGuardHooks = {
  ...
  resourceGate: ReturnType<typeof createResourceGateHook> | null
}
...
export function createToolGuardHooks(args: {
  ...
  const resourceGate = isHookEnabled("resource-gate")
    ? safeHook("resource-gate", () => createResourceGateHook(ctx))
    : null
