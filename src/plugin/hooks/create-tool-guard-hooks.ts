...
export type ToolGuardHooks = {
  ...
  plannotatorGate: ReturnType<typeof createPlannotatorGateHook> | null
}
...
export function createToolGuardHooks(args: {
  ...
  const plannotatorGate = isHookEnabled("plannotator-gate")
    ? safeHook("plannotator-gate", () => createPlannotatorGateHook(ctx))
    : null
