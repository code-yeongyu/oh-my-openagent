...
export const FRONTEND_REACT_NEXTJS_SKILL_DESCRIPTION = "React 19 (Server Components, useOptimistic, useActionState) and Next.js 15 App Router (Server Actions, Streaming, Routing) patterns"
