...
export const hyperplanSkill: BuiltinSkill = {
  name: "hyperplan",
  description: "Adversarial multi-agent planning via team-mode; loads the hyperplan workflow used by the /hyperplan command.",
  template: `# HYPERPLAN — Adversarial Multi-Agent Planning
