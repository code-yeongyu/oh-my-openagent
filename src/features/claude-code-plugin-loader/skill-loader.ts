...
import { parseAllowedTools } from "../opencode-skill-loader/allowed-tools-parser"
import type { LoadedSkill, SkillMetadata } from "../opencode-skill-loader/types"
...
export function discoverPluginSkills(plugins: LoadedPlugin[]): LoadedSkill[] {
