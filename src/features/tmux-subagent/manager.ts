  ...
  constructor(ctx: PluginInput, tmuxConfig: TmuxConfig, deps: TmuxUtilDeps = defaultTmuxDeps) {
    ...
    const fallbackUrl = `http://localhost:${defaultPort}`
      try {
        ...
        try {
          if (rawServerUrl) {uest? I'm adding react query to my project and wondering if I have to have server/client-specific query functions or if I can get away with sharing a single server query function between the two use cases?
