...
export interface DetectedKeyword {
  type: "ultrawork" | "search" | "analyze" | "tmux-script" | "watch-github-issues"
  message: string
}
...
export function detectKeywordsWithType(text: string, agentName?: string, modelID?: string): DetectedKeyword[] {
  const textWithoutCode = removeCodeBlocks(text)
  const types: Array<"ultrawork" | "search" | "analyze" | "tmux-script" | "watch-github-issues"> = ["ultrawork", "search", "analyze", "tmux-script", "watch-github-issues"]
