...
export const CONTINUATION_PROMPT = `Todo continuation reminder.

Incomplete tasks remain in this session. Continue the next pending task.

- Proceed without asking for permission
- Mark each task complete when finished
- Do not stop until all tasks are done
- Keep the original task and role consistent while continuing.`
