...
import { HOOK_NAME, getPrometheusAgents, ALLOWED_EXTENSIONS, ALLOWED_PATH_PREFIX, BLOCKED_TOOLS, PLANNING_CONSULT_WARNING, PROMETHEUS_WORKFLOW_REMINDER } from "./constants"
...
export function createPrometheusMdOnlyHook(ctx: PluginInput) {
  return {
    "tool.execute.before": async (
      ...
      if (!agentName || !getPrometheusAgents().includes(agentName)) {
        return
      }
