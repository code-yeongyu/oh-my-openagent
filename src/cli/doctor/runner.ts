...
function buildTimeoutResult(start: number, options: DoctorOptions): DoctorResult {
  const timeoutResult: DoctorResult = {
    ...
    tools: { lspServers: [], astGrepCli: false, astGrepNapi: false, commentChecker: false, ghCli: { installed: false, authenticated: false, username: null }, mcpBuiltin: [], mcpUser: [], plannotator: { installed: false, version: null, path: null } },
